...
import ProjectSetup from '@docs/shared/partials/authentication-workflow-uikit/project-setup/index.mdx';
import ProjectImplement from '@docs/shared/partials/authentication-workflow-uikit/project-implementation/index.mdx';
import ProjectTest from '@docs/shared/partials/authentication-workflow-uikit/project-test/index.mdx';
import Reference from '@docs/shared/partials/authentication-workflow-uikit/reference/index.mdx';
