...
import ProjectSetup from '@docs/shared/partials/authentication-workflow/project-setup/index.mdx';
import ProjectImplement from '@docs/shared/partials/authentication-workflow/project-implementation/index.mdx';
import ProjectTest from '@docs/shared/partials/authentication-workflow/project-test/index.mdx';
import Reference from '@docs/shared/partials/authentication-workflow/reference/index.mdx';
