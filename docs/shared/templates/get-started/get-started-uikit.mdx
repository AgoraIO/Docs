import PlatformSelector, { PlatfromContent } from '@site/src/components/PlatformSelector';
...
<PlatformSelector platform={props.platform}>
  <PlatfromContent>Hello</PlatfromContent>
</PlatformSelector>
