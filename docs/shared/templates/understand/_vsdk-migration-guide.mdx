import Web from '@docs/shared/partials/vsdk-migration-guide/_web.mdx';
import Android from '@docs/shared/partials/vsdk-migration-guide/_android.mdx';
import Ios from '@docs/shared/partials/vsdk-migration-guide/_ios.mdx';
