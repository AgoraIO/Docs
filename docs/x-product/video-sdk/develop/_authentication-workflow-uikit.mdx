...
import ProjectSetup from '@docs/x-product/partials/authentication-workflow-uikit/project-setup/index.mdx';
import ProjectImplement from '@docs/x-product/partials/authentication-workflow-uikit/project-implementation/index.mdx';
import ProjectTest from '@docs/x-product/partials/authentication-workflow-uikit/project-test/index.mdx';
import Reference from '@docs/x-product/partials/authentication-workflow-uikit/reference/index.mdx';
