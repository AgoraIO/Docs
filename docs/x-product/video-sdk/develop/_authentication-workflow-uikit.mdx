...
import ProjectSetup from '@docs/x-product/video-sdk/develop/authentication-workflow-uikit/project-setup/index.mdx';
import ProjectImplement from '@docs/x-product/video-sdk/develop/authentication-workflow-uikit/project-implementation/index.mdx';
import ProjectTest from '@docs/x-product/video-sdk/develop/authentication-workflow-uikit/project-test/index.mdx';
import Reference from '@docs/x-product/video-sdk/develop/authentication-workflow-uikit/reference/index.mdx';
...
- Open the [Get started](/get-started)project you created.
