...
import ProjectSetup from '@docs/x-product/video-sdk/develop/authentication-workflow/project-setup/index.mdx';
import ProjectImplement from '@docs/x-product/video-sdk/develop/authentication-workflow/project-implementation/index.mdx';
import ProjectTest from '@docs/x-product/video-sdk/develop/authentication-workflow/project-test/index.mdx';
import Reference from '@docs/x-product/video-sdk/develop/authentication-workflow/reference/index.mdx';
