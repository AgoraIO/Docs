...
import ProjectSetup from '@docs/x-product/partials/authentication-workflow/project-setup/index.mdx';
import ProjectImplement from '@docs/x-product/partials/authentication-workflow/project-implementation/index.mdx';
import ProjectTest from '@docs/x-product/partials/authentication-workflow/project-test/index.mdx';
import Reference from '@docs/x-product/partials/authentication-workflow/reference/index.mdx';
