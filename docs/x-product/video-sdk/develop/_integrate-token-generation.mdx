...
import Prerequites from '@docs/x-product/partials/prerequities.mdx';
import ProjectSetup from '@docs/x-product/partials/integrate-token-generation/project-setup/index.mdx';
import ProjectImplement from '@docs/x-product/partials/integrate-token-generation/project-implementation/index.mdx';
import ProjectTest from '@docs/x-product/partials/integrate-token-generation/project-test/index.mdx';
import Reference from '@docs/x-product/partials/integrate-token-generation/reference/index.mdx';
