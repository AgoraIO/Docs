import Web from '@docs/x-product/partials/vsdk-migration-guide/_web.mdx';
import Android from '@docs/x-product/partials/vsdk-migration-guide/_android.mdx';
import Ios from '@docs/x-product/partials/vsdk-migration-guide/_ios.mdx';
